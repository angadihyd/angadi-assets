...
('country-chicken','Country Chicken','Nati Kodi',520,'kg','chicken','product/country chiken.png','product/country chiken animated video.mp4','Nati',null,'Free-range country chicken raised in open villages. Firm and flavourful — made for slow cooking. Available whole or curry cut.',true,true,2),
...
('baby-goat-legs','Baby Goat Legs','Pilla Meka Kalu',980,'kg','goat','product/baby-goat-legs.png',null,'Premium',null,'Tender baby goat legs, perfect for slow-roast or biryani. Rare and seasonal — worth booking ahead.',false,false,4),
('country-eggs','Country Eggs','Nati Kodi Gudlu',12,'egg','eggs','product/country-eggs.png',null,'Farm Fresh',null,'Deep golden yolk, rich flavour. Free-range hens from Telangana farms. Packed in 6s and 12s to your door.',true,false,5),
...
('goat-legs','Goat Legs','Meka Kalu',400,'4 pcs','goat','product/legs.png',null,'Fresh',null,'Collagen-rich village goat legs — perfect for paya curry, slow masala, and bone broth.',true,false,7),
('goat-liver','Goat Liver','Meka Kalleja',1000,'kg','goat','product/liver.png',null,'Premium',null,'Farm-fresh goat liver — rich in iron, B12, and Vitamin A. Village goat, processed same day.',true,false,8),
